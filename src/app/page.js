  ...
  return (
    <RevealOnScroll delay={delay}>
      <div className="group relative h-full">
        ...
        <div className="absolute inset-0 bg-white rounded-[2rem] shadow-sm border border-black/5 transition-all duration-500 group-hover:shadow-xl group-hover:scale-[1.02]" />
        
        <div className="relative p-8 z-10">
          <div className="mb-6 inline-flex p-4 rounded-2xl bg-secondary text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-inner group-hover:shadow-lg group-hover:rotate-6 transform">
            {icon}
          </div>
...
function QuickAccessButton({ icon, label, href = "#" }) {
  return (
    <a
      href={href}
      className="flex flex-col items-center justify-center gap-3 rounded-[2rem] bg-white/80 backdrop-blur-md p-6 shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-white/60 group min-w-[150px] relative overflow-hidden"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-white via-white/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
      <span className="relative p-4 rounded-2xl bg-secondary text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-inner">
        {icon}
      </span>
...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-[#fdfbf7] font-sans selection:bg-primary/20 overflow-x-hidden">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative h-[95vh] min-h-[700px] w-full overflow-hidden flex items-center justify-center rounded-b-[3rem] shadow-2xl z-20">
          {/* Video Background */}
          ...
          <div className="relative z-10 container mx-auto px-4 mt-16">
            <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in-up">
              <div className="inline-flex items-center gap-3 rounded-full bg-white/10 px-5 py-2 text-sm font-bold text-white backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/20 transition-colors cursor-default">
              ...
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-white font-heading leading-[0.9] tracking-tight drop-shadow-2xl">
                Passion Meets <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-400 italic pr-4 font-serif">Performance.</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-6">
                <button className="group relative overflow-hidden rounded-full bg-primary px-10 py-5 text-lg font-bold text-white shadow-2xl transition-all hover:scale-105 active:scale-95 hover:shadow-primary/50">
                  <div className="absolute inset-0 bg-white/20 translate-y-full transition-transform group-hover:translate-y-0" />
                  <span className="relative flex items-center gap-2">
                    Schedule a Visit <ArrowRightIcon />
                  </span>
                </button>
                <button className="rounded-full bg-white/10 px-10 py-5 text-lg font-bold text-white backdrop-blur-md border-2 border-white/30 hover:bg-white hover:text-primary transition-all hover:scale-105 active:scale-95">
                  Explore Programs
                </button>
              </div>
            </div>
        ...
        <section className="py-24 px-4 relative">
          <BlobBackground color="bg-accent/10" position="-left-24 top-20" size="w-[600px] h-[600px]" />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <RevealOnScroll className="relative order-2 lg:order-1">
                <div className="relative z-10">
                  ...
                  {/* Floating Elements */}
                  <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-[2rem] shadow-xl border border-gray-100 max-w-[240px] animate-float hidden md:block">
                    <p className="text-5xl font-bold text-primary font-heading">
                      <CountUp end={20} suffix="+" />
                    </p>
                    <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mt-1">Years of Excellence</p>
                  </div>
                  <div className="absolute -top-10 -right-10 bg-secondary p-6 rounded-full shadow-lg hidden md:block animate-float-delayed">
              ...
              <div className="space-y-10 order-1 lg:order-2">
                <RevealOnScroll delay={200}>
                  <div className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary font-bold text-sm uppercase tracking-widest mb-4">
                    Who We Are
                  </div>
                ...
                <RevealOnScroll delay={300}>
                  ...
                  <p className="text-lg text-gray-500 leading-relaxed mt-4">
                    Through our dual focus on <strong className="text-gray-900">Dance</strong> and <strong className="text-gray-900">Visual Arts</strong>, we provide a nurturing environment where scholars grow into confident, well-rounded leaders.
                  </p>
                </RevealOnScroll>
        ...
        <section className="relative py-32 overflow-hidden">
          <div className="absolute inset-0 bg-secondary skew-y-3 transform origin-top-left scale-110 -z-10 rounded-[4rem]" />
        ...
        {/* Spotlights - Collage Layout */}
        <section className="py-32 px-4 bg-background relative overflow-hidden">
          <BlobBackground color="bg-accent/10" position="left-1/4 bottom-0" size="w-[600px] h-[600px]" />
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              ...
              <RevealOnScroll delay={200}>
                <button className="px-8 py-4 rounded-full border-2 border-gray-200 font-bold text-gray-600 hover:border-primary hover:text-primary hover:bg-white transition-all shadow-sm">
                  View Gallery
                </button>
              </RevealOnScroll>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[300px]">
                  ...
                  <div className="h-full w-full rounded-[2.5rem] overflow-hidden shadow-2xl relative">
                    ...
                    <div className="absolute bottom-0 left-0 p-10 text-white w-full">
                      <div className="transform transition-transform duration-500 group-hover:-translate-y-2">
                        <span className="bg-primary px-4 py-1.5 rounded-full text-sm font-bold uppercase mb-4 inline-block tracking-wide shadow-md">Dance Major</span>
                        <h3 className="text-4xl font-bold font-heading mb-2">Winter Showcase 2024</h3>
                        <p className="text-gray-200 text-lg line-clamp-2 max-w-lg opacity-90">Our students performed original choreography to a sold-out audience, demonstrating months of dedication.</p>
                      </div>
                    </div>
                  </div>
                </RevealOnScroll>
              ...
              <div className="md:col-span-5 md:row-span-1 relative group">
                <RevealOnScroll delay={200} className="h-full">
                  <div className="h-full w-full rounded-[2.5rem] overflow-hidden shadow-xl relative">
                    ...
                    <div className="absolute bottom-0 left-0 p-8 text-white">
                      <span className="bg-accent text-black px-3 py-1 rounded-full text-xs font-bold uppercase mb-2 inline-block">Art Dept</span>
              ...
              <div className="md:col-span-5 md:row-span-1 relative group">
                <RevealOnScroll delay={300} className="h-full">
                  <div className="h-full w-full bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-100 flex flex-col justify-center relative overflow-hidden group-hover:bg-gray-50 transition-colors">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2" />
                    <h3 className="text-2xl font-bold font-heading text-gray-900 mb-2 relative z-10">Faculty Highlight</h3>
                    <p className="text-gray-600 mb-6 relative z-10">Meet the dedicated educators guiding our students toward excellence.</p>
                    <a href="/more-about-bda" className="inline-flex items-center text-primary font-bold hover:underline relative z-10">
              ...
              <RevealOnScroll>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="group flex gap-6 items-center p-6 rounded-[2rem] bg-white shadow-sm border border-gray-100 hover:shadow-xl hover:border-primary/20 transition-all cursor-pointer transform hover:-translate-y-1">
                      <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-secondary flex flex-col items-center justify-center text-gray-900 font-bold border border-gray-200 group-hover:bg-primary group-hover:text-white transition-colors">
                        <span className="text-2xl">{item.date.split(' ')[1]}</span>
                        <span className="text-xs uppercase opacity-80">{item.date.split(' ')[0]}</span>
                      </div>
                      <div>
                        <span className="inline-block px-2 py-0.5 rounded-md bg-gray-100 text-gray-500 text-[10px] font-bold uppercase tracking-wide mb-2 group-hover:bg-white/50">{item.category}</span>
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                  ...
                  <div className="space-y-4 relative z-10">
                     {[
                      ...
                      <div key={i} className="flex items-center gap-6 p-4 rounded-2xl hover:bg-secondary/50 transition-colors cursor-pointer group">
                         <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold group-hover:bg-primary group-hover:text-white transition-colors flex-shrink-0">
                           {i + 1}
                         </div>
                  ...
                  <button className="w-full mt-8 py-4 rounded-2xl bg-gray-900 text-white font-bold hover:bg-primary transition-colors shadow-lg">
                    View Full Calendar
                  </button>
                </div>
              </RevealOnScroll>
        ...
        <section className="py-24 px-4">
          <div className="container mx-auto">
            <RevealOnScroll className="relative overflow-hidden rounded-[3.5rem] bg-primary px-6 py-28 text-center text-white shadow-2xl">
              ...
              <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-accent/20 rounded-full blur-[120px] translate-x-1/3 translate-y-1/3" />
              
              <div className="relative z-10 max-w-4xl mx-auto space-y-10">
                <h2 className="text-6xl md:text-8xl font-bold font-heading tracking-tight">You Belong Here.</h2>
                <p className="text-2xl opacity-90 font-medium max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
                  <button className="w-full sm:w-auto rounded-full bg-white px-10 py-5 text-lg font-bold text-primary shadow-xl hover:bg-gray-50 transition-all hover:scale-105 active:scale-95">
                    Apply Now
                  </button>
